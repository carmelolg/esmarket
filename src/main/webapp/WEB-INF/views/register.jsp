		...
		<div class="container">
			<div class="row">
				...
				<div class="span9">
					...
					<h3>Registration</h3>
					<div class="well">
						<sf:form method="post" action="register" class="form-horizontal"
							modelAttribute="registeringClient">
							...
							<div class="control-group">
								...
								<div class="controls">
									<sf:input path="eMail" type="text" id="input_email"
							...
							<div class="control-group">
								<label class="control-label" for="aditionalInfo">Additional
									information</label>
								<div class="controls">
