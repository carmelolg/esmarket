				...
				<ul class="breadcrumb">
					<li><c:url value="details" var="store_management" /> <a
						href="${store_management}?id=${storeID}"><i
							class="icon-search"></i>Details storage</a><span class="divider"><i class="icon-arrow-right"></i></span></li>
					<li class="active">${store.name}</li>
				</ul>
				<ul class="breadcrumb">
					<li><c:url value="list_of_product" var="list_of_product" /> <a
						href="${list_of_product}?storeID=${storeID}"><i class="icon-chevron-right"></i>List
							of products</a><span class="divider"><i class="icon-arrow-right"></i></span></li>
					<li class="active">Add product</li>
				</ul>
				<!-- end cronologia -->

					<div class="well well-small">
						<sf:form action="add_product"
							...
							<hr>
							Category <br>
							<sf:errors path="category" style="color:red"></sf:errors><br>
							<sf:input path="category" type="text" />
							<br>
							Brand<br>
							<sf:errors path="brand" style="color:red"></sf:errors><br>
							<sf:input path="brand" type="text" />
							<br>
							<hr>
							Quantity <br>
							<sf:errors path="quantity" style="color:red"></sf:errors><br>
							<sf:input path="quantity" type="text" />
							<br>
							Unit Price<br>
							<sf:errors path="unitPrice" style="color:red"></sf:errors><br>
							<sf:input path="unitPrice" type="text" />
							<br>
							Image <br>
							<sf:errors path="image" style="color:red"></sf:errors><br>
							<sf:input path="image" type="text" />
							<br>
							Description<br>
							<sf:errors path="description" style="color:red"></sf:errors><br>
							<sf:input path="description" type="text" />
							<br>
							In sale <sf:checkbox path="forSale" />
							<br>
							<hr>

							<sf:button type="submit" class="btn btn-primary">Add Product</sf:button>
						</sf:form>
						<!-- PRODUCT LIST -->
					</div>
					<!-- BEST OFFERS -->
